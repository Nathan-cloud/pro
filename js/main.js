...
var animator = (() => {
    ...
    var fe = ["transformPerspective", "x", "y", "z", "translateX", "translateY", "translateZ", "scale", "scaleX", "scaleY", "rotate", "rotateX", "rotateY", "rotateZ", "skew", "skewX", "skewY"],
        X = new Set(fe);
    ...
    var z = ["transformPerspective", "x", "y", "z", "translateX", "translateY", "translateZ", "scale", "scaleX", "scaleY", "rotate", "rotateX", "rotateY", "rotateZ", "skew", "skewX", "skewY"],
        Oe = {
            x: "translateX",
            y: "translateY",
            z: "translateZ",
    ...
    function _({
        ...
        return o && !e.z && (r += "translateZ(0)"), r = r.trim(), i ? r = i(e, r) : n && a && (r = "none"), r
    }
  ...
  if (window.__framer_disable_appear_effects_optimization__ !== true) {
    const respectReducedMotion = false;
      ...
      const appearAnimations = {
            rgvnv5: {
            transformTemplate:
        "rotate(-30deg) __Appear_Animation_Transform__",
        },
        lai921: {
            transformTemplate:
        "rotate(31deg) __Appear_Animation_Transform__",
        },
        "1ua9kck": {
            transformTemplate:
        "rotate(31deg) __Appear_Animation_Transform__",
        ...
        u8grdn: {
            transformTemplate:
        "rotate(5deg) __Appear_Animation_Transform__",
        },
        "1q0i7bd": {
            transformTemplate:
        "rotate(-30deg) __Appear_Animation_Transform__",
        ...
        eeel6c: {
            transformTemplate:
        "rotate(60deg) __Appear_Animation_Transform__",
        },
        "1je3xvb": {
            transformTemplate:
        "rotate(31deg) __Appear_Animation_Transform__",
